...
# Use flood fill to remove the exterior white background only, preserving internal white.
# We'll create a mask by flood-filling from the top-left corner.
mask = Image.new('L', logo.size, 0)
ImageDraw.floodfill(logo, (0, 0), (0, 0, 0, 0), thresh=30)
logo_clean = logo
...
targets = {
    "bp_nomatic_pack_1.png": (0.28, 0.40, 0.35, -5, 0.85),
    "bp_pd_30l_1.jpg": (0.35, 0.50, 0.40, 0, 1.0),
    "bp_nomatic_bag_1.png": (0.28, 0.40, 0.35, -4, 0.90)
}

# Redownload the pristine front images first to clear the corrupted ones
import requests
urls = {
