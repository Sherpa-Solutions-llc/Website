document.addEventListener("DOMContentLoaded", async () => {
    try {
        ...
        const res = await fetch('https://sherpa-solutions-api-production.up.railway.app/api/content', { cache: 'no-store' });
        if (res.ok) {
...
async function autoRegisterTags() {
    ...
    for (const el of elements) {
        ...
        registerPromises.push(
            fetch('https://sherpa-solutions-api-production.up.railway.app/api/content/register', {
                method: 'POST',
