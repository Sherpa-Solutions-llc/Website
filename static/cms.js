document.addEventListener("DOMContentLoaded", async () => {
    try {
        ...
        const API_BASE = (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') ? '' : 'https://sherpa-solutions-api-production.up.railway.app';
...
async function autoRegisterTags() {
    ...
    for (const el of elements) {
        ...
        registerPromises.push(
            fetch(`${API_BASE}/api/content/register`, {
                method: 'POST',
