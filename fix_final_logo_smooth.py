...
urls = {
    # Front faces (The user considers this the 'back' - smooth panel)
    ...
    # Back faces (Strap sides - Must be CLEANed)
...
# Apply logos EXCLUSIVELY to the SMOOTH sides (the exact physical BACK of the backpacks)
targets = {
    # Nomatic Pack (Smooth side = Photo 1)
    "bp_nomatic_pack_1.png": (0.35, 0.44, 0.28, 4, 0.88),
    
    # Peak Design 30L (Smooth side = Photo 1)
    "bp_pd_30l_1.jpg": (0.42, 0.50, 0.40, 0, 1.0),
    
    # Nomatic Bag (Smooth side = Photo 1)
...
print("Fixed images with the REAL user logo onto the SMOOTH sides.")
